...
export default function Posts({ post }) {
    ...
    return(
        <Fragment>
            <div className='container mx-auto min-h-full flex flex-row justify-center'>
                <div className=' h-[700px]'>
                    <h1 className='text-center text-6xl font-bold'>{post.title}</h1><br></br>
                    <h1 className='text-center text-2xl font-semibold'>{" This is category " + post.category}</h1><br></br>
                    <h5 className='text-2xl font-semibold'>{formatDate(post.date)}</h5>
                ...
                <div className='w-[800px] p-6 flex items-center justify-center'>
